...
import { Box, Heading, HStack,VStack, IconButton, useColorModeValue, Input, Button,Image, Text, useToast, Modal, ModalOverlay, ModalFooter, ModalContent, ModalHeader, ModalCloseButton, ModalBody, useDisclosure } from '@chakra-ui/react'
          ...
          <ModalContent>
            ...
            <ModalCloseButton/>
              <VStack spacing={4} p={4}>
                <Input placeholder='ProductName' name='name' value={updatedProduct.name} 
